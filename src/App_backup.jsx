...
import { MapPin, Clock, Phone, Mail, ChevronRight, Activity, Dumbbell } from 'lucide-react';
...
const About = () => (
  <section id="about" className="section-padding" style={{ position: 'relative' }}>
    <Reveal className="bento-grid">
      <div className="bento-item glass" style={{ gridColumn: 'span 2', gridRow: 'span 2', padding: '0', overflow: 'hidden' }}>
        <img src={gallery1} alt="Kişisel Eğitim" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        <div style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', padding: '40px', background: 'linear-gradient(transparent, #0a0a0a)' }}>
          <h2 style={{ fontSize: '3rem', marginBottom: '10px', fontStyle: 'italic' }}>GYM SPORIUM <span className="text-gradient">FARKI</span></h2>
          <p style={{ color: '#ccc', fontSize: '1.1rem' }}>Sınıfının en iyisi ekipmanlar ve uzman kadromuzla yanınızdayız.</p>
        </div>
      </div>
      
      <div className="bento-item glass" style={{ padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <Activity size={48} color="var(--accent)" style={{ marginBottom: '20px' }} />
        <h3 style={{ fontSize: '1.5rem', marginBottom: '10px' }}>Kişisel Koçluk</h3>
        <p style={{ color: 'var(--text-muted)' }}>Hedefinize özel birebir takip ve programlama.</p>
      </div>

      <div className="bento-item glass" style={{ padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <Dumbbell size={48} color="var(--accent)" style={{ marginBottom: '20px' }} />
        <h3 style={{ fontSize: '1.5rem', marginBottom: '10px' }}>Modern Ekipman</h3>
        <p style={{ color: 'var(--text-muted)' }}>Dünya standartlarında yenilikçi ve ergonomik makineler.</p>
      </div>
    </Reveal>
  </section>
);
  ...
  <section id="programs" className="section-padding" style={{ backgroundColor: 'var(--secondary)' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px' }}>
      ...
      {[ 
        ...
        <Reveal key={idx} delay={idx * 150} className="program-card">
...
const Pricing = () => (
  <section id="pricing" className="section-padding">
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto', alignItems: 'center' }}>
      ...
      <Reveal delay={100} className="pricing-card">
        ...
        <a href="#contact" className="btn-primary" style={{ width: '100%' }}>Kayıt Ol</a>
      </Reveal>

      <Reveal delay={200} className="pricing-card popular" style={{ transform: 'scale(1.05)' }}>
        ...
        <a href="#contact" className="btn-primary" style={{ width: '100%', boxShadow: '0 0 20px rgba(0,255,204,0.3)' }}>Hemen Başla</a>
      </Reveal>

      <Reveal delay={300} className="pricing-card">
...
const Trainers = () => (
  <section id="trainers" className="section-padding" style={{ backgroundColor: 'var(--secondary)' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '30px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <Reveal delay={100} className="trainer-card">
      ...
      <Reveal delay={200} className="trainer-card">
...
const SocialInstagram = () => (
  <section id="social" className="section-padding">
    <Reveal delay={100} style={{ textAlign: 'center', marginBottom: '50px' }}>
      <a href="https://www.instagram.com/gymsporium/" target="_blank" rel="noreferrer" style={{ display: 'inline-block' }}>
      ...
      <a href="https://www.instagram.com/gymsporium/" target="_blank" rel="noreferrer" style={{ color: 'var(--text-muted)', fontSize: '1.2rem', textDecoration: 'none' }}>
        @gymsporium (1,418 Followers)
      </a>
    </Reveal>
    
    <Reveal delay={200} className="insta-grid">
      {/* These can be replaced by actual Instagram embed iframes */}
      {[gallery1, gallery2, gallery3, gallery4, gallery5, gallery6, gallery7, gallery8, gallery9, gallery10, gallery11, gallery12, gallery13].map((img, idx) => (
        <a key={idx} href="https://www.instagram.com/gymsporium/" target="_blank" rel="noreferrer" className="insta-item">
  ...
  <section id="contact" className="section-padding" style={{ backgroundColor: 'var(--secondary)', position: 'relative' }}>
    <Reveal className="bento-grid" style={{ gridTemplateColumns: '1fr 1fr' }}>
      ...
      <div className="glass" style={{ padding: '50px', borderRadius: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', marginBottom: '30px' }}>
          <a href="https://www.instagram.com/gymsporium/" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center' }}>
            <Instagram color="var(--accent)" size={32} />
          </a>
          <div>
            <h4 style={{ fontSize: '1.2rem', marginBottom: '5px' }}>Sosyal Medya</h4>
            <a href="https://www.instagram.com/gymsporium/" target="_blank" rel="noreferrer" style={{ color: '#ccc', textDecoration: 'none' }}>@gymsporium</a>
          </div>
        </div>
      </div>
...
const Footer = () => (
  <footer style={{ background: '#000', padding: '40px 10%', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
    ...
    <div style={{ display: 'flex', gap: '20px' }}>
      <a href="https://www.instagram.com/gymsporium/" target="_blank" rel="noreferrer" style={{ color: 'var(--text-muted)', textDecoration: 'none', transition: 'color 0.3s' }}>
...
function App() {
  return (
    <div>
      ...
      <a href="https://wa.me/905555555555" target="_blank" rel="noreferrer" className="whatsapp-float" aria-label="WhatsApp ile İletişime Geç">
        <WhatsApp size={36} />
      </a>
    </div>
  );
